...
const NavBar = () => {
  ...
  return (
    ...
    >
      <Container>
        {data?.logo && (
          <Navbar.Brand as={NavLink} to="/"> {/* Cambia href por to */}
            <img
            ...
            {data
              && data.sections?.map((section, index) => (section?.type === 'link' ? (
                ...
                <InternalNavLink
                  ...
                  className="navbar__link"
                  to={section.href} // Usa to en lugar de href
                  theme={theme}
                >
                  {section.title}
                </InternalNavLink>
...
export default NavBar; // Elimina la línea que envuelve NavBarWithRouter
